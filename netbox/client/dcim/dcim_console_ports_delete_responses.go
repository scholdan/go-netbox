...
func (o *DcimConsolePortsDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /dcim/console-ports/{id}/] dcim_console-ports_delete", response, response.Code())
	}
}
...
// Code gets the status code for the dcim console ports delete no content response
func (o *DcimConsolePortsDeleteNoContent) Code() int {
	return 204
}
