...
func (o *DcimInterfaceTemplatesBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /dcim/interface-templates/] dcim_interface-templates_bulk_delete", response, response.Code())
	}
}
...
// Code gets the status code for the dcim interface templates bulk delete no content response
func (o *DcimInterfaceTemplatesBulkDeleteNoContent) Code() int {
	return 204
}
