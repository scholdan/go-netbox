...
func (o *DcimFrontPortTemplatesBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /dcim/front-port-templates/] dcim_front-port-templates_bulk_delete", response, response.Code())
	}
}
...
// Code gets the status code for the dcim front port templates bulk delete no content response
func (o *DcimFrontPortTemplatesBulkDeleteNoContent) Code() int {
	return 204
}
