...
// NewDcimDeviceBayTemplatesBulkDeleteParams creates a new DcimDeviceBayTemplatesBulkDeleteParams object,
...
func NewDcimDeviceBayTemplatesBulkDeleteParams() *DcimDeviceBayTemplatesBulkDeleteParams {
	return &DcimDeviceBayTemplatesBulkDeleteParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDcimDeviceBayTemplatesBulkDeleteParamsWithTimeout creates a new DcimDeviceBayTemplatesBulkDeleteParams object
...
// NewDcimDeviceBayTemplatesBulkDeleteParamsWithContext creates a new DcimDeviceBayTemplatesBulkDeleteParams object
...
// NewDcimDeviceBayTemplatesBulkDeleteParamsWithHTTPClient creates a new DcimDeviceBayTemplatesBulkDeleteParams object
...
func (o *DcimDeviceBayTemplatesBulkDeleteParams) WithDefaults() *DcimDeviceBayTemplatesBulkDeleteParams {
	o.SetDefaults()
	return o
}
...
func (o *DcimDeviceBayTemplatesBulkDeleteParams) WithTimeout(timeout time.Duration) *DcimDeviceBayTemplatesBulkDeleteParams {
...
func (o *DcimDeviceBayTemplatesBulkDeleteParams) WithContext(ctx context.Context) *DcimDeviceBayTemplatesBulkDeleteParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the dcim device bay templates bulk delete params
func (o *DcimDeviceBayTemplatesBulkDeleteParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the dcim device bay templates bulk delete params
func (o *DcimDeviceBayTemplatesBulkDeleteParams) WithHTTPClient(client *http.Client) *DcimDeviceBayTemplatesBulkDeleteParams {
...
func (o *DcimDeviceBayTemplatesBulkDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
