...
func (o *IpamVlansBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /ipam/vlans/] ipam_vlans_bulk_partial_update", response, response.Code())
	}
}
...
func (o *IpamVlansBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *IpamVlansBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/vlans/][%d] ipamVlansBulkPartialUpdateOK %s", 200, payload)
}
