...
func (o *IpamServicesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ipam/services/] ipam_services_bulk_update", response, response.Code())
	}
}
...
func (o *IpamServicesBulkUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /ipam/services/][%d] ipamServicesBulkUpdateOK %s", 200, payload)
}
