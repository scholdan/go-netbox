...
func (o *IpamIPAddressesBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /ipam/ip-addresses/] ipam_ip-addresses_bulk_delete", response, response.Code())
	}
}
...
func (o *IpamIPAddressesBulkDeleteNoContent) Code() int {
	return 204
}
