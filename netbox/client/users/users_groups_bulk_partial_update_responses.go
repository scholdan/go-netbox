...
func (o *UsersGroupsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /users/groups/] users_groups_bulk_partial_update", response, response.Code())
	}
}
...
// Code gets the status code for the users groups bulk partial update o k response
func (o *UsersGroupsBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *UsersGroupsBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /users/groups/][%d] usersGroupsBulkPartialUpdateOK %s", 200, payload)
}
