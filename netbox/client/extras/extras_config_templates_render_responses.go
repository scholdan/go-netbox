...
func (o *ExtrasConfigTemplatesRenderReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		result := NewExtrasConfigTemplatesRenderDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ExtrasConfigTemplatesRenderCreated) Error() string {
	return fmt.Sprintf("[POST /extras/config-templates/{id}/render/][%d] extrasConfigTemplatesRenderCreated  %+v", 201, o.Payload)
}
...
func NewExtrasConfigTemplatesRenderDefault(code int) *ExtrasConfigTemplatesRenderDefault {
	return &ExtrasConfigTemplatesRenderDefault{
		_statusCode: code,
	}
}
...
*/
type ExtrasConfigTemplatesRenderDefault struct {
	_statusCode int
...
func (o *ExtrasConfigTemplatesRenderDefault) Error() string {
	return fmt.Sprintf("[POST /extras/config-templates/{id}/render/][%d] extras_config-templates_render default  %+v", o._statusCode, o.Payload)
}
...
func (o *ExtrasConfigTemplatesRenderDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
