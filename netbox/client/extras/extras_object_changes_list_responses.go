...
func (o *ExtrasObjectChangesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /extras/object-changes/] extras_object-changes_list", response, response.Code())
	}
}
...
func (o *ExtrasObjectChangesListOK) Error() string {
	...
	return fmt.Sprintf("[GET /extras/object-changes/][%d] extrasObjectChangesListOK %s", 200, payload)
}
