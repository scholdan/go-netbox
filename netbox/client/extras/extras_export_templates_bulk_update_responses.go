...
func (o *ExtrasExportTemplatesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /extras/export-templates/] extras_export-templates_bulk_update", response, response.Code())
	}
}
...
func (o *ExtrasExportTemplatesBulkUpdateOK) Code() int {
	return 200
}

func (o *ExtrasExportTemplatesBulkUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /extras/export-templates/][%d] extrasExportTemplatesBulkUpdateOK %s", 200, payload)
}
