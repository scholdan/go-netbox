...
// NewVpnTunnelTerminationsReadParams creates a new VpnTunnelTerminationsReadParams object,
...
func NewVpnTunnelTerminationsReadParams() *VpnTunnelTerminationsReadParams {
	return &VpnTunnelTerminationsReadParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewVpnTunnelTerminationsReadParamsWithTimeout creates a new VpnTunnelTerminationsReadParams object
...
// NewVpnTunnelTerminationsReadParamsWithContext creates a new VpnTunnelTerminationsReadParams object
...
// NewVpnTunnelTerminationsReadParamsWithHTTPClient creates a new VpnTunnelTerminationsReadParams object
...
func (o *VpnTunnelTerminationsReadParams) WithDefaults() *VpnTunnelTerminationsReadParams {
	o.SetDefaults()
	return o
}
...
func (o *VpnTunnelTerminationsReadParams) WithTimeout(timeout time.Duration) *VpnTunnelTerminationsReadParams {
...
func (o *VpnTunnelTerminationsReadParams) WithContext(ctx context.Context) *VpnTunnelTerminationsReadParams {
	o.SetContext(ctx)
	return o
}
...
func (o *VpnTunnelTerminationsReadParams) WithHTTPClient(client *http.Client) *VpnTunnelTerminationsReadParams {
...
func (o *VpnTunnelTerminationsReadParams) WithID(id int64) *VpnTunnelTerminationsReadParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the vpn tunnel terminations read params
func (o *VpnTunnelTerminationsReadParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *VpnTunnelTerminationsReadParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
