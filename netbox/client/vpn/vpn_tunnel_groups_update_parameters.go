...
func (o *VpnTunnelGroupsUpdateParams) WithData(data *models.TunnelGroup) *VpnTunnelGroupsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the vpn tunnel groups update params
func (o *VpnTunnelGroupsUpdateParams) SetData(data *models.TunnelGroup) {
	o.Data = data
}
