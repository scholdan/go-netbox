...
func (o *VirtualizationVirtualMachinesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /virtualization/virtual-machines/] virtualization_virtual-machines_bulk_partial_update", response, response.Code())
	}
}
...
// Code gets the status code for the virtualization virtual machines bulk partial update o k response
func (o *VirtualizationVirtualMachinesBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *VirtualizationVirtualMachinesBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /virtualization/virtual-machines/][%d] virtualizationVirtualMachinesBulkPartialUpdateOK %s", 200, payload)
}
