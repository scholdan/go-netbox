...
// NewVirtualizationClustersBulkDeleteParams creates a new VirtualizationClustersBulkDeleteParams object,
...
func NewVirtualizationClustersBulkDeleteParams() *VirtualizationClustersBulkDeleteParams {
	return &VirtualizationClustersBulkDeleteParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewVirtualizationClustersBulkDeleteParamsWithTimeout creates a new VirtualizationClustersBulkDeleteParams object
...
// NewVirtualizationClustersBulkDeleteParamsWithContext creates a new VirtualizationClustersBulkDeleteParams object
...
// NewVirtualizationClustersBulkDeleteParamsWithHTTPClient creates a new VirtualizationClustersBulkDeleteParams object
...
func (o *VirtualizationClustersBulkDeleteParams) WithDefaults() *VirtualizationClustersBulkDeleteParams {
	o.SetDefaults()
	return o
}
...
func (o *VirtualizationClustersBulkDeleteParams) WithTimeout(timeout time.Duration) *VirtualizationClustersBulkDeleteParams {
...
func (o *VirtualizationClustersBulkDeleteParams) WithContext(ctx context.Context) *VirtualizationClustersBulkDeleteParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the virtualization clusters bulk delete params
func (o *VirtualizationClustersBulkDeleteParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the virtualization clusters bulk delete params
func (o *VirtualizationClustersBulkDeleteParams) WithHTTPClient(client *http.Client) *VirtualizationClustersBulkDeleteParams {
...
func (o *VirtualizationClustersBulkDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
