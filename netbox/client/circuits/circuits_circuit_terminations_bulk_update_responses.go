...
func (o *CircuitsCircuitTerminationsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /circuits/circuit-terminations/] circuits_circuit-terminations_bulk_update", response, response.Code())
	}
}
...
func (o *CircuitsCircuitTerminationsBulkUpdateOK) Code() int {
	return 200
}

func (o *CircuitsCircuitTerminationsBulkUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /circuits/circuit-terminations/][%d] circuitsCircuitTerminationsBulkUpdateOK %s", 200, payload)
}
