...
// NewCircuitsCircuitTerminationsPathsParams creates a new CircuitsCircuitTerminationsPathsParams object,
...
func NewCircuitsCircuitTerminationsPathsParams() *CircuitsCircuitTerminationsPathsParams {
	return &CircuitsCircuitTerminationsPathsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCircuitsCircuitTerminationsPathsParamsWithTimeout creates a new CircuitsCircuitTerminationsPathsParams object
...
// NewCircuitsCircuitTerminationsPathsParamsWithContext creates a new CircuitsCircuitTerminationsPathsParams object
...
// NewCircuitsCircuitTerminationsPathsParamsWithHTTPClient creates a new CircuitsCircuitTerminationsPathsParams object
...
func (o *CircuitsCircuitTerminationsPathsParams) WithDefaults() *CircuitsCircuitTerminationsPathsParams {
	o.SetDefaults()
	return o
}
...
func (o *CircuitsCircuitTerminationsPathsParams) WithTimeout(timeout time.Duration) *CircuitsCircuitTerminationsPathsParams {
...
func (o *CircuitsCircuitTerminationsPathsParams) WithContext(ctx context.Context) *CircuitsCircuitTerminationsPathsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the circuits circuit terminations paths params
func (o *CircuitsCircuitTerminationsPathsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the circuits circuit terminations paths params
func (o *CircuitsCircuitTerminationsPathsParams) WithHTTPClient(client *http.Client) *CircuitsCircuitTerminationsPathsParams {
...
func (o *CircuitsCircuitTerminationsPathsParams) WithID(id int64) *CircuitsCircuitTerminationsPathsParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the circuits circuit terminations paths params
func (o *CircuitsCircuitTerminationsPathsParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *CircuitsCircuitTerminationsPathsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
