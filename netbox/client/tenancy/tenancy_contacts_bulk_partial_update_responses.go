...
func (o *TenancyContactsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /tenancy/contacts/] tenancy_contacts_bulk_partial_update", response, response.Code())
	}
}
...
func (o *TenancyContactsBulkPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /tenancy/contacts/][%d] tenancyContactsBulkPartialUpdateOK %s", 200, payload)
}
