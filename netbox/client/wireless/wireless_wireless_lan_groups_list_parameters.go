...
func (o *WirelessWirelessLanGroupsListParams) WithID(id *string) *WirelessWirelessLanGroupsListParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the wireless wireless lan groups list params
func (o *WirelessWirelessLanGroupsListParams) SetID(id *string) {
	o.ID = id
}

// WithIDGt adds the iDGt to the wireless wireless lan groups list params
func (o *WirelessWirelessLanGroupsListParams) WithIDGt(iDGt *string) *WirelessWirelessLanGroupsListParams {
	o.SetIDGt(iDGt)
	return o
}
...
func (o *WirelessWirelessLanGroupsListParams) WithIDGte(iDGte *string) *WirelessWirelessLanGroupsListParams {
	o.SetIDGte(iDGte)
	return o
}
...
func (o *WirelessWirelessLanGroupsListParams) WithIDLt(iDLt *string) *WirelessWirelessLanGroupsListParams {
	o.SetIDLt(iDLt)
	return o
}
...
func (o *WirelessWirelessLanGroupsListParams) WithIDLte(iDLte *string) *WirelessWirelessLanGroupsListParams {
	o.SetIDLte(iDLte)
	return o
}
...
func (o *WirelessWirelessLanGroupsListParams) WithIDn(iDn *string) *WirelessWirelessLanGroupsListParams {
	o.SetIDn(iDn)
	return o
}

// SetIDn adds the idN to the wireless wireless lan groups list params
func (o *WirelessWirelessLanGroupsListParams) SetIDn(iDn *string) {
	o.IDn = iDn
}
...
func (o *WirelessWirelessLanGroupsListParams) WithParentID(parentID *string) *WirelessWirelessLanGroupsListParams {
...
func (o *WirelessWirelessLanGroupsListParams) WithParentIDn(parentIDn *string) *WirelessWirelessLanGroupsListParams {
