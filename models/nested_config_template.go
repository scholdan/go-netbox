...
func (m *NestedConfigTemplate) validateName(formats strfmt.Registry) error {
...
func (m *NestedConfigTemplate) validateURL(formats strfmt.Registry) error {
...
func (m *NestedConfigTemplate) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedConfigTemplate) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedConfigTemplate) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
