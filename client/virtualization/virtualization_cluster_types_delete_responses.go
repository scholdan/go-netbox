...
func (o *VirtualizationClusterTypesDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /virtualization/cluster-types/{id}/] virtualization_cluster-types_delete", response, response.Code())
	}
}
...
// Code gets the status code for the virtualization cluster types delete no content response
func (o *VirtualizationClusterTypesDeleteNoContent) Code() int {
	return 204
}
