...
func (o *VirtualizationVirtualMachinesDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /virtualization/virtual-machines/{id}/] virtualization_virtual-machines_delete", response, response.Code())
	}
}
...
// Code gets the status code for the virtualization virtual machines delete no content response
func (o *VirtualizationVirtualMachinesDeleteNoContent) Code() int {
	return 204
}
