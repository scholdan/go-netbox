...
func (o *DcimCableTerminationsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /dcim/cable-terminations/] dcim_cable-terminations_bulk_partial_update", response, response.Code())
	}
}
...
// Code gets the status code for the dcim cable terminations bulk partial update o k response
func (o *DcimCableTerminationsBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *DcimCableTerminationsBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/cable-terminations/][%d] dcimCableTerminationsBulkPartialUpdateOK %s", 200, payload)
}
