...
func (o *DcimRacksElevationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /dcim/racks/{id}/elevation/] dcim_racks_elevation", response, response.Code())
	}
}
...
// Code gets the status code for the dcim racks elevation o k response
func (o *DcimRacksElevationOK) Code() int {
	return 200
}
