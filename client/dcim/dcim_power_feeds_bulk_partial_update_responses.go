...
func (o *DcimPowerFeedsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /dcim/power-feeds/] dcim_power-feeds_bulk_partial_update", response, response.Code())
	}
}
...
// Code gets the status code for the dcim power feeds bulk partial update o k response
func (o *DcimPowerFeedsBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *DcimPowerFeedsBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/power-feeds/][%d] dcimPowerFeedsBulkPartialUpdateOK %s", 200, payload)
}
