...
func (o *DcimModulesBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /dcim/modules/] dcim_modules_bulk_delete", response, response.Code())
	}
}
...
// Code gets the status code for the dcim modules bulk delete no content response
func (o *DcimModulesBulkDeleteNoContent) Code() int {
	return 204
}
