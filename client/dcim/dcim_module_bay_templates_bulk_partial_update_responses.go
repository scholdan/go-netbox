...
func (o *DcimModuleBayTemplatesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /dcim/module-bay-templates/] dcim_module-bay-templates_bulk_partial_update", response, response.Code())
	}
}
...
func (o *DcimModuleBayTemplatesBulkPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /dcim/module-bay-templates/][%d] dcimModuleBayTemplatesBulkPartialUpdateOK %s", 200, payload)
}
