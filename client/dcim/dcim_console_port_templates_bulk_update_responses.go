...
func (o *DcimConsolePortTemplatesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /dcim/console-port-templates/] dcim_console-port-templates_bulk_update", response, response.Code())
	}
}
...
// Code gets the status code for the dcim console port templates bulk update o k response
func (o *DcimConsolePortTemplatesBulkUpdateOK) Code() int {
	return 200
}

func (o *DcimConsolePortTemplatesBulkUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/console-port-templates/][%d] dcimConsolePortTemplatesBulkUpdateOK %s", 200, payload)
}
