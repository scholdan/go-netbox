...
func (o *DcimInventoryItemRolesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /dcim/inventory-item-roles/{id}/] dcim_inventory-item-roles_read", response, response.Code())
	}
}
...
func (o *DcimInventoryItemRolesReadOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/inventory-item-roles/{id}/][%d] dcimInventoryItemRolesReadOK %s", 200, payload)
}
