...
func (o *DcimDeviceRolesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /dcim/device-roles/{id}/] dcim_device-roles_read", response, response.Code())
	}
}
...
// Code gets the status code for the dcim device roles read o k response
func (o *DcimDeviceRolesReadOK) Code() int {
	return 200
}
