...
func (o *DcimRegionsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /dcim/regions/] dcim_regions_bulk_partial_update", response, response.Code())
	}
}
...
func (o *DcimRegionsBulkPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /dcim/regions/][%d] dcimRegionsBulkPartialUpdateOK %s", 200, payload)
}
