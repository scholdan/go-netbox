...
func (o *DcimInventoryItemTemplatesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /dcim/inventory-item-templates/] dcim_inventory-item-templates_bulk_partial_update", response, response.Code())
	}
}
...
func (o *DcimInventoryItemTemplatesBulkPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /dcim/inventory-item-templates/][%d] dcimInventoryItemTemplatesBulkPartialUpdateOK %s", 200, payload)
}
