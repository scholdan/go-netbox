...
func (o *DcimPlatformsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /dcim/platforms/] dcim_platforms_bulk_partial_update", response, response.Code())
	}
}
...
// Code gets the status code for the dcim platforms bulk partial update o k response
func (o *DcimPlatformsBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *DcimPlatformsBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/platforms/][%d] dcimPlatformsBulkPartialUpdateOK %s", 200, payload)
}
