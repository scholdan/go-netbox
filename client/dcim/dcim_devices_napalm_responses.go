...
func (o *DcimDevicesNapalmReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /dcim/devices/{id}/napalm/] dcim_devices_napalm", response, response.Code())
	}
}
...
// Code gets the status code for the dcim devices napalm o k response
func (o *DcimDevicesNapalmOK) Code() int {
	return 200
}
