...
func (o *DcimRackRolesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /dcim/rack-roles/] dcim_rack-roles_bulk_update", response, response.Code())
	}
}
...
// Code gets the status code for the dcim rack roles bulk update o k response
func (o *DcimRackRolesBulkUpdateOK) Code() int {
	return 200
}

func (o *DcimRackRolesBulkUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /dcim/rack-roles/][%d] dcimRackRolesBulkUpdateOK %s", 200, payload)
}
