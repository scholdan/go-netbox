...
func (o *DcimRackRolesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /dcim/rack-roles/{id}/] dcim_rack-roles_read", response, response.Code())
	}
}
...
func (o *DcimRackRolesReadOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/rack-roles/{id}/][%d] dcimRackRolesReadOK %s", 200, payload)
}
