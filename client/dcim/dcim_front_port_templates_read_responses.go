...
func (o *DcimFrontPortTemplatesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /dcim/front-port-templates/{id}/] dcim_front-port-templates_read", response, response.Code())
	}
}
...
func (o *DcimFrontPortTemplatesReadOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/front-port-templates/{id}/][%d] dcimFrontPortTemplatesReadOK %s", 200, payload)
}
