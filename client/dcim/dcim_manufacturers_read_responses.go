...
func (o *DcimManufacturersReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /dcim/manufacturers/{id}/] dcim_manufacturers_read", response, response.Code())
	}
}
...
func (o *DcimManufacturersReadOK) Error() string {
	...
	return fmt.Sprintf("[GET /dcim/manufacturers/{id}/][%d] dcimManufacturersReadOK %s", 200, payload)
}
