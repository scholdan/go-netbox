...
func (o *DcimConsolePortsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /dcim/console-ports/] dcim_console-ports_bulk_partial_update", response, response.Code())
	}
}
...
// Code gets the status code for the dcim console ports bulk partial update o k response
func (o *DcimConsolePortsBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *DcimConsolePortsBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /dcim/console-ports/][%d] dcimConsolePortsBulkPartialUpdateOK %s", 200, payload)
}
