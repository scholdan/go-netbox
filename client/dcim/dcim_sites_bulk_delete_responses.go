...
func (o *DcimSitesBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /dcim/sites/] dcim_sites_bulk_delete", response, response.Code())
	}
}
...
// Code gets the status code for the dcim sites bulk delete no content response
func (o *DcimSitesBulkDeleteNoContent) Code() int {
	return 204
}
