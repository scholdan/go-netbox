...
func (o *DcimPlatformsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /dcim/platforms/{id}/] dcim_platforms_read", response, response.Code())
	}
}
...
// Code gets the status code for the dcim platforms read o k response
func (o *DcimPlatformsReadOK) Code() int {
	return 200
}
