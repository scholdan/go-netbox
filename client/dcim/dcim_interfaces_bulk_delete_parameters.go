...
func (o *DcimInterfacesBulkDeleteParams) WithTimeout(timeout time.Duration) *DcimInterfacesBulkDeleteParams {
...
func (o *DcimInterfacesBulkDeleteParams) WithContext(ctx context.Context) *DcimInterfacesBulkDeleteParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DcimInterfacesBulkDeleteParams) WithHTTPClient(client *http.Client) *DcimInterfacesBulkDeleteParams {
...
func (o *DcimInterfacesBulkDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
