...
func (o *CircuitsCircuitTypesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /circuits/circuit-types/{id}/] circuits_circuit-types_read", response, response.Code())
	}
}
...
func (o *CircuitsCircuitTypesReadOK) Error() string {
	...
	return fmt.Sprintf("[GET /circuits/circuit-types/{id}/][%d] circuitsCircuitTypesReadOK %s", 200, payload)
}
