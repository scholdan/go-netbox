...
func (o *CircuitsCircuitTypesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /circuits/circuit-types/] circuits_circuit-types_bulk_update", response, response.Code())
	}
}
...
func (o *CircuitsCircuitTypesBulkUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /circuits/circuit-types/][%d] circuitsCircuitTypesBulkUpdateOK %s", 200, payload)
}
