...
func (o *WirelessWirelessLansBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /wireless/wireless-lans/] wireless_wireless-lans_bulk_partial_update", response, response.Code())
	}
}
...
// Code gets the status code for the wireless wireless lans bulk partial update o k response
func (o *WirelessWirelessLansBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *WirelessWirelessLansBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /wireless/wireless-lans/][%d] wirelessWirelessLansBulkPartialUpdateOK %s", 200, payload)
}
