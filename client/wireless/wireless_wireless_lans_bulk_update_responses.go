...
func (o *WirelessWirelessLansBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /wireless/wireless-lans/] wireless_wireless-lans_bulk_update", response, response.Code())
	}
}
...
func (o *WirelessWirelessLansBulkUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /wireless/wireless-lans/][%d] wirelessWirelessLansBulkUpdateOK %s", 200, payload)
}
