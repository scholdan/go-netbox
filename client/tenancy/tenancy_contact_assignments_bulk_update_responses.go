...
func (o *TenancyContactAssignmentsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /tenancy/contact-assignments/] tenancy_contact-assignments_bulk_update", response, response.Code())
	}
}
...
// Code gets the status code for the tenancy contact assignments bulk update o k response
func (o *TenancyContactAssignmentsBulkUpdateOK) Code() int {
	return 200
}

func (o *TenancyContactAssignmentsBulkUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/contact-assignments/][%d] tenancyContactAssignmentsBulkUpdateOK %s", 200, payload)
}
