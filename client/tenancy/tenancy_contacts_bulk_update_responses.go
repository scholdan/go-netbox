...
func (o *TenancyContactsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /tenancy/contacts/] tenancy_contacts_bulk_update", response, response.Code())
	}
}
...
// Code gets the status code for the tenancy contacts bulk update o k response
func (o *TenancyContactsBulkUpdateOK) Code() int {
	return 200
}

func (o *TenancyContactsBulkUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /tenancy/contacts/][%d] tenancyContactsBulkUpdateOK %s", 200, payload)
}
