...
// NewExtrasEventRulesReadParams creates a new ExtrasEventRulesReadParams object,
...
func NewExtrasEventRulesReadParams() *ExtrasEventRulesReadParams {
	return &ExtrasEventRulesReadParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewExtrasEventRulesReadParamsWithTimeout creates a new ExtrasEventRulesReadParams object
...
// NewExtrasEventRulesReadParamsWithContext creates a new ExtrasEventRulesReadParams object
...
// NewExtrasEventRulesReadParamsWithHTTPClient creates a new ExtrasEventRulesReadParams object
...
ExtrasEventRulesReadParams contains all the parameters to send to the API endpoint
	...
	for the extras event rules read operation.

	Typically these are written to a http.Request.
*/
type ExtrasEventRulesReadParams struct {
