...
func (o *ExtrasTagsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /extras/tags/] extras_tags_bulk_update", response, response.Code())
	}
}
...
func (o *ExtrasTagsBulkUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /extras/tags/][%d] extrasTagsBulkUpdateOK %s", 200, payload)
}
