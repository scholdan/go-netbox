...
func (o *UsersUsersBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /users/users/] users_users_bulk_update", response, response.Code())
	}
}
...
// Code gets the status code for the users users bulk update o k response
func (o *UsersUsersBulkUpdateOK) Code() int {
	return 200
}

func (o *UsersUsersBulkUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/users/][%d] usersUsersBulkUpdateOK %s", 200, payload)
}
