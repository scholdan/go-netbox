...
func (o *IpamL2vpnTerminationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ipam/l2vpn-terminations/] ipam_l2vpn-terminations_list", response, response.Code())
	}
}
...
func (o *IpamL2vpnTerminationsListOK) Error() string {
	...
	return fmt.Sprintf("[GET /ipam/l2vpn-terminations/][%d] ipamL2vpnTerminationsListOK %s", 200, payload)
}
