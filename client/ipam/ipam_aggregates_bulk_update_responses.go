...
func (o *IpamAggregatesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ipam/aggregates/] ipam_aggregates_bulk_update", response, response.Code())
	}
}
...
func (o *IpamAggregatesBulkUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /ipam/aggregates/][%d] ipamAggregatesBulkUpdateOK %s", 200, payload)
}
