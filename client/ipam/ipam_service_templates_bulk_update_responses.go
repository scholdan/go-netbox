...
func (o *IpamServiceTemplatesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ipam/service-templates/] ipam_service-templates_bulk_update", response, response.Code())
	}
}
...
func (o *IpamServiceTemplatesBulkUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /ipam/service-templates/][%d] ipamServiceTemplatesBulkUpdateOK %s", 200, payload)
}
