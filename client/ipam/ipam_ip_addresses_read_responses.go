...
func (o *IpamIPAddressesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ipam/ip-addresses/{id}/] ipam_ip-addresses_read", response, response.Code())
	}
}
...
func (o *IpamIPAddressesReadOK) Error() string {
	...
	return fmt.Sprintf("[GET /ipam/ip-addresses/{id}/][%d] ipamIpAddressesReadOK %s", 200, payload)
}
