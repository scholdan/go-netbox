...
func (o *IpamVrfsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ipam/vrfs/] ipam_vrfs_bulk_update", response, response.Code())
	}
}
...
func (o *IpamVrfsBulkUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /ipam/vrfs/][%d] ipamVrfsBulkUpdateOK %s", 200, payload)
}
