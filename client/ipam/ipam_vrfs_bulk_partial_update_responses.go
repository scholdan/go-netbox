...
func (o *IpamVrfsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /ipam/vrfs/] ipam_vrfs_bulk_partial_update", response, response.Code())
	}
}
...
func (o *IpamVrfsBulkPartialUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /ipam/vrfs/][%d] ipamVrfsBulkPartialUpdateOK %s", 200, payload)
}
