...
func (o *IpamIPRangesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ipam/ip-ranges/{id}/] ipam_ip-ranges_read", response, response.Code())
	}
}
...
func (o *IpamIPRangesReadOK) Error() string {
	...
	return fmt.Sprintf("[GET /ipam/ip-ranges/{id}/][%d] ipamIpRangesReadOK %s", 200, payload)
}
