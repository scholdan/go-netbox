...
// NewIpamServiceTemplatesReadParams creates a new IpamServiceTemplatesReadParams object,
...
func NewIpamServiceTemplatesReadParams() *IpamServiceTemplatesReadParams {
	return &IpamServiceTemplatesReadParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewIpamServiceTemplatesReadParamsWithTimeout creates a new IpamServiceTemplatesReadParams object
...
// NewIpamServiceTemplatesReadParamsWithContext creates a new IpamServiceTemplatesReadParams object
...
// NewIpamServiceTemplatesReadParamsWithHTTPClient creates a new IpamServiceTemplatesReadParams object
...
func (o *IpamServiceTemplatesReadParams) WithDefaults() *IpamServiceTemplatesReadParams {
	o.SetDefaults()
	return o
}
...
func (o *IpamServiceTemplatesReadParams) WithContext(ctx context.Context) *IpamServiceTemplatesReadParams {
	o.SetContext(ctx)
	return o
}
...
func (o *IpamServiceTemplatesReadParams) WithID(id int64) *IpamServiceTemplatesReadParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the ipam service templates read params
func (o *IpamServiceTemplatesReadParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *IpamServiceTemplatesReadParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
