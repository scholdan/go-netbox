...
func (o *IpamVlansBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ipam/vlans/] ipam_vlans_bulk_update", response, response.Code())
	}
}
...
func (o *IpamVlansBulkUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /ipam/vlans/][%d] ipamVlansBulkUpdateOK %s", 200, payload)
}
