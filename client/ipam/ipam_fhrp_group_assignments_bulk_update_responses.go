...
func (o *IpamFhrpGroupAssignmentsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ipam/fhrp-group-assignments/] ipam_fhrp-group-assignments_bulk_update", response, response.Code())
	}
}
...
func (o *IpamFhrpGroupAssignmentsBulkUpdateOK) Code() int {
	return 200
}

func (o *IpamFhrpGroupAssignmentsBulkUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /ipam/fhrp-group-assignments/][%d] ipamFhrpGroupAssignmentsBulkUpdateOK %s", 200, payload)
}
