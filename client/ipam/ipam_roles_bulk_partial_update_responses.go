...
func (o *IpamRolesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PATCH /ipam/roles/] ipam_roles_bulk_partial_update", response, response.Code())
	}
}
...
func (o *IpamRolesBulkPartialUpdateOK) Code() int {
	return 200
}

func (o *IpamRolesBulkPartialUpdateOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /ipam/roles/][%d] ipamRolesBulkPartialUpdateOK %s", 200, payload)
}
